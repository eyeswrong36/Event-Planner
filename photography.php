...
<head>
    <title>Event Planner - Photography Page</title>
...
<body>
    ...
    <!-- /.header -->
    <!-- page-header -->
    <div class="page-header" style="background:url('<?=$gs['Photo']; ?>')center no-repeat;background-size:cover;">
        <div class="container">
            <div class="row">
                <!-- page caption -->
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="page-caption">
                        <h1 class="page-title" style="text-shadow:3px 3px 3px black;">Photography Packages/Services</h1>
                    </div>
                </div>
                <!-- /.page caption -->
            </div>
                ...
                <div class="row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Photography</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <form class="form-row" method="get">
                        ...
                        <!-- /.price -->
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 ">
                            <button class="btn btn-default btn-block" type="submit">Filter Photographers</button>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                if(isset($_GET['search']) AND isset($_GET['filter'])){
                    ...
                    $f = $_GET['filter'];
                    if($f==0 AND $s!=""){
                        $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodName LIKE '%$s%' OR prodLoc LIKE '%$s%' AND prodType='3' ORDER BY rowID DESC");

                    }else if($f!=0 AND $s==""){
                        if($f==1){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodType='3' AND prodName LIKE '%$s%' OR prodLoc LIKE '%s%' ORDER BY prodRatings DESC");
                        }else if($f==2){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodType='3' AND prodName LIKE '%$s%' OR prodLoc LIKE '%s%' ORDER BY prodPrice DESC");
                        }else if($f==3){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodType='3' AND prodName LIKE '%$s%' OR prodLoc LIKE '%s%' ORDER BY prodPrice ASC");
                        }
                        

                    }else if($f!=0 AND $s!=""){
                        if($f==1){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodName LIKE '%$s%' OR prodLoc LIKE '%$s%' AND prodType='3' ORDER BY prodRatings DESC");
                        }else if($f==2){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodName LIKE '%$s%' OR prodLoc LIKE '%$s%' AND prodType='3' ORDER BY prodPrice DESC");
                        }else if($f==3){
                            $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodName LIKE '%$s%' OR prodLoc LIKE '%$s%' AND prodType='3' ORDER BY prodPrice ASC");
                        }
                        
                    }
                }else{
                    $showInfo = $con->prepare("SELECT * FROM tbl_prod WHERE prodType='3' ORDER BY rowID DESC");
                }
                $showInfo->execute();
                while ($si= $showInfo->fetch()) {
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="vendor-thumbnail">
                            ...
                            <div class="vendor-content">
                                ...
                                <p class="vendor-address"><b>Owner: </b><?=$si['prodOwner']; ?></p>
                            </div>
                            <div class="vendor-meta">
                                <div class="vendor-meta-item vendor-meta-item-bordered">
                                    ...
                                    <div class="vendor-meta-item vendor-meta-item-bordered">
                                        ...
                                        <span class="rating-count vendor-text">(<?=$si['prodRatings'];?>) Star Rates</span></div>
                                    </div>
                                    <!-- /.Vendor Content -->
                                </div>
                                <!-- /.Vendor thumbnail -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Suggested Coutures</h3>
                        </div>
                        <?php 
                        $showCat = $con->prepare("SELECT * FROM tbl_prod WHERE prodType='2' ORDER BY rowID DESC LIMIT 3");
                        $showCat->execute();
                                    ...
                                    <div class="vendor-meta">
                                        <div class="vendor-meta-item vendor-meta-item-bordered">
                                            ...
                                            <div class="vendor-meta-item vendor-meta-item-bordered">
                                                ...
                                                <span class="rating-count vendor-text">(<?=$sc['prodRatings'];?>) Star Rates</span></div>
                                            </div>
                                            <!-- /.Vendor Content -->
                                        </div>
                                        <!-- /.Vendor thumbnail -->
