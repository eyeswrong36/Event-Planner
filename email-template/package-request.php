...
<head>
  ...
  <title>Event Planner Activate Request</title>
  ...
  <?php if (isset($_GET['transID'])) {
    ...
    //check transID
    $userID = $con->prepare("SELECT * FROM tbl_transaction WHERE TransID = '$transID' ");
    $userID->execute();
    $uID = $userID->fetch();
    if($uID){
      $verifyAcc = $con->prepare("UPDATE tbl_transaction SET TransStatus = '1' WHERE TransID ='$transID' ");
      $verifyAcc->execute();
    }
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p class="lead">Congratulations your Request has been Sent!
                      </p>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                  <tr>
                                    <td>
                                      <p class="user-text">
                                        Stay Notified as the vendor Approved your Request. Thank you!
                                      </p>
                                      </td>
                                    </tr>
                                  </tbody>
