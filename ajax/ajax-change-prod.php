...
$updatePackage = $con->prepare("UPDATE tbl_prod SET prodName='$prodName', prodUnit='$Unit', prodPrice ='$Price', prodDesc='$PackageDesc', prodLoc='$encodedLoc', prodDays='$encodedDays', prodImg='$path', prodType='$prodType' WHERE prodID='$prodID' ");
$updatePackage->execute();

echo "Updating Package Success!";
